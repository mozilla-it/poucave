...
NAMESPACE=poucave-microservice
SVC_NAME=poucave-microservice
SUBDOMAIN=poucave
...
sed -i -e "s|@SECRET_NAME@|$SECRET_NAME|g" -e "s|@SHORT_SHA@|$SHORT_SHA|g" -e "s|@NAMESPACE@|$NAMESPACE|g" -e "s|@SVC_NAME@|$SVC_NAME|g" -e "s|@PROJECT@|${PROJ_ENV}|g"  k8s/deploy-${PROJ_ENV}.yaml
